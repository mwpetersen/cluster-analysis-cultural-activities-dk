...
```
In figure \@ref(fig:map-clusters-3) we see that with 3 clusters Copenhagen, Frederiksberg, Gentofte and Aarhus are now in their own cluster. 
...
mapDK(values = "Cluster", id = "municipality", data = df_cluster_3, map.title = "Map with municipalities grouped in 2 clusters")
