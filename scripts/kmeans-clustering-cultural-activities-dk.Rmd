...
```
The cross table below shows the similarity in the results clearly.

```{r fig10-cluster, fig.cap="Cross table with the K = 3 K-means solution and the cut = 3 hierarchical solution"}
